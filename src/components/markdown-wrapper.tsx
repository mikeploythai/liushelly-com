...
const MarkdownWrapper = forwardRef<HTMLDivElement, MarkdownHTMLAttributes>(
  ({ theme = "default", className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "prose prose-sm max-w-none md:prose-base prose-headings:font-heading prose-headings:font-medium prose-a:normal-case prose-blockquote:border-none prose-blockquote:p-0 prose-blockquote:font-normal prose-strong:text-current",
        theme === "default" &&
